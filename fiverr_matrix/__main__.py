...
class FiverrBridge(Bridge):
    name = "fiverr-matrix"
    module = "fiverr_matrix"
    beeper_service_name = "fiverr"
    beeper_network_name = "fiverr"
    command = "fiverr-matrix"
    description = "A Matrix-Fiverr Messages puppeting bridge."
    repo_url = "https://github.com/zabilal/fiverr-bridge"
    version = version
    ...
    def prepare_stop(self):
        ...
        for puppet in Puppet.by_custom_mxid.values():
            puppet.stop()
        self.log.debug("Stopping Fiverr listeners")
        User.shutdown = True

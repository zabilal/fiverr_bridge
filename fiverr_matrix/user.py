...
from fiverr_messaging import URN, FiverrMessaging
from fiverr_messaging.api_objects import (
    Conversation,
    ConversationEvent,
    ReactionSummary,
...
class User(DBUser, BaseUser):
    ...
    client: FiverrMessaging | None = None
    ...
    @classmethod
    def init_cls(cls, bridge: FiverrBridge) -> AsyncIterable[Awaitable[bool]]:
        cls.bridge = bridge
    ...
    async def load_session(self, is_startup: bool = False) -> bool:
        ...
        self.client = FiverrMessaging.from_cookies_and_headers(
    ...
    async def on_logged_in(self, cookies: dict[str, str], headers: Optional[dict[str, str]]):
        ...
        self.client = FiverrMessaging.from_cookies_and_headers(cookies, headers)

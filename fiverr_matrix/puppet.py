...
from fiverr_messaging import URN
from fiverr_messaging.api_objects import MessagingMember, Picture
...
class Puppet(DBPuppet, BasePuppet):
    ...
    @classmethod
    def init_cls(cls, bridge: "FiverrBridge") -> AsyncIterable[Awaitable[None]]:
        cls.bridge = bridge

...
# SEED_URL = "https://www.fiverr.com/login"
# # LOGIN_URL = "https://www.linkedin.com/checkpoint/lg/login-submit"
# LOGIN_URL = "https://www.fiverr.com/user_sessions"
...
@command_handler(
    ...
    help_section=SECTION_AUTH,
    help_text="""
        Log in to Fiverr using cookies from an existing Fiverr browser session. To extract the
        cookies go to your browser developer tools, open the Network tab, then copy the `Cookie`
        header from one of the requests to `https://www.fiverr.com/` and paste the result into
...
@command_handler(
    ...
    help_section=SECTION_AUTH,
    help_text="""
        Log in to Fiverr using a "Copy as cURL" export from an existing Fiverr browser session.
    """,

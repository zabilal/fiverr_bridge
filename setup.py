...
from fiverr_matrix.get_version import git_tag, git_revision, version, linkified_version
...
with open("fiverr_matrix/version.py", "w") as version_file:
...
setuptools.setup(
    ...
    package_data={
        "fiverr_matrix": ["example-config.yaml"],
    },
    data_files=[
        (".", ["fiverr_matrix/example-config.yaml"]),
    ],
